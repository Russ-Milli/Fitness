...
import com.ryan.fitnessapp.model.Product
import com.ryan.fitnessapp.model.Upload
import com.ryan.fitnessapp.navigation.ROUTE_LOGIN

class reviewmodel(var navController: NavController, var context: Context) {
    var authRepository: AuthModel
    var progress: ProgressDialog

    init {
        authRepository = AuthModel(navController, context)
