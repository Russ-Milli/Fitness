...
fun Reviews(navController: NavHostController) {
    ...
    Column(modifier = Modifier.fillMaxSize(),
        ...
        var productRepository = reviewmodel(navController, context)
...
fun ProductItem(name:String, quantity:String, price:String, id:String,
                navController:NavHostController, productRepository: reviewmodel
) {
...
private fun Reviewprev() {
    Reviews(navController = rememberNavController())
}
